...
class ShoppingItemCreate(_Base):
    ...
    icon_key: Optional[Literal["apple", "banana", "carrot", "tomato", "salad", "potato", "lemon", "milk", "cheese", "yogurt", "egg", "bread", "croissant", "pasta", "rice", "coffee", "water", "juice", "oil", "canned", "spices", "icecream", "cleaner", "toilet-paper", "laundry", "pet", "shopping", "produce", "dairy", "bakery", "pantry", "frozen", "beverage", "household"]] = None
