...
The daily page (`/`) is Cronicl’s visual source of truth. Secondary routes inherit its hierarchy: current action/value first, contextual information second, optional detail on explicit expansion.
