...
expect(settings.includes('class="settings-list"'), 'settings does not use the canonical list composition');
expect(!settings.includes('class="tiles"'), 'settings retains the competing tile-grid composition');
expect(settingsTile.includes('class="settings-row"'), 'settings item does not use a canonical list row');
