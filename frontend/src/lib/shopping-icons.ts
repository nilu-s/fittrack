...
export const shoppingIcons: ShoppingIconDefinition[] = [
  ...
  { key: 'avocado', label: 'Avocado', category: 'produce', aliases: ['avocado'] },
  { key: 'carrot', label: 'Karotte', category: 'produce', aliases: ['karotte', 'möhre', 'brokkoli'] },
  { key: 'pepper', label: 'Paprika', category: 'produce', aliases: ['paprika'] },
  { key: 'cucumber', label: 'Gurke', category: 'produce', aliases: ['gurke', 'zucchini'] },
  { key: 'onion', label: 'Zwiebel', category: 'produce', aliases: ['zwiebel', 'knoblauch'] },
