...
<style>
  ...
  .day-footer { padding:var(--space-1); background:var(--surface-navigation); border:1px solid var(--border-default); border-radius:var(--radius-surface); box-shadow:var(--shadow-modal); }
</style>
