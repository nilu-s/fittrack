...
<style>
  ...
  .grid,.planning-notes{grid-template-columns:repeat(3,minmax(0,1fr))}
  .note{aspect-ratio:auto;min-height:116px;padding:12px;gap:6px;cursor:pointer;touch-action:pan-y}
  ...
  @media(max-width:620px){.grid,.planning-notes{grid-template-columns:repeat(2,minmax(0,1fr))}.note{min-height:108px}.board-header h2{font-size:18px}}
