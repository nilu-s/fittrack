...
<style>
  .meal-day { background:var(--surface-default); border:1px solid var(--border-subtle); border-radius:12px; overflow:hidden; } .head { display:flex; gap:12px; align-items:center; justify-content:space-between; padding:14px; } h2,p { margin:0; } h2 { font-size:16px; } .head p,small,span,.empty { color:var(--text-tertiary); font-size:12px; } button,select,input { min-height:40px; border-radius:8px; font:inherit; } button { border:1px solid var(--border-default); background:var(--surface-raised); color:var(--text-primary); padding:0 10px; cursor:pointer; } button:disabled { opacity:.5; cursor:not-allowed; } button:focus-visible,input:focus-visible,select:focus-visible { outline:2px solid var(--status-info); outline-offset:2px; } .nutrition-summary { display:grid; grid-template-columns:repeat(4,1fr); gap:8px; padding:0 14px 14px; } .macro { display:grid; gap:2px; } .macro span { font-size:11px; text-transform:uppercase; font-weight:700; } .macro strong { font-size:14px; } .add,.setup,.editor-fields,.add-item,.editor-actions { display:flex; gap:8px; padding:0 14px 14px; } input,select { min-width:0; flex:1; border:1px solid var(--border-default); background:var(--surface-raised); color:var(--text-primary); padding:0 10px; } .setup label { flex:1; display:grid; gap:5px; font-size:12px; color:var(--text-secondary); } .entries { border-top:1px solid var(--border-subtle); } article { display:flex; gap:8px; align-items:center; justify-content:space-between; padding:11px 14px; border-bottom:1px solid var(--border-subtle); } .entry-body { min-width:0; display:grid; gap:2px; } strong { overflow:hidden; text-overflow:ellipsis; white-space:nowrap; font-size:14px; } .actions { display:flex; flex-wrap:wrap; justify-content:flex-end; gap:5px; flex-shrink:0; } .actions button,.editor button { min-height:32px; font-size:12px; } .subtle { opacity:.75; } .danger,.icon { color:var(--status-danger); } .consumed>.entry-body strong { color:var(--status-success); } .skipped>.entry-body { opacity:.55; text-decoration:line-through; } .empty,.error { padding:14px; } .error,.proposal-error { color:var(--status-danger); } .editor { width:100%; display:grid; gap:8px; } .editor-fields,.add-item,.editor-actions { padding:0; } .add-item select:first-child { flex:0 0 110px; } .add-item input { flex:0 0 72px; } .add-item button { flex:0 0 40px; } .item-list { display:grid; gap:5px; padding:8px; border-radius:8px; background:var(--surface-raised); } .draft-item { display:flex; align-items:center; justify-content:space-between; gap:8px; } .icon { padding:0; width:30px; min-height:30px; } .primary { background:var(--action-primary); border-color:var(--action-primary); color:var(--text-on-accent); font-weight:700; } .proposal { padding:0; font-size:12px; color:var(--text-secondary); } .file-input { display:none; } @media(max-width:620px) { .head { align-items:flex-start; flex-direction:column; } .nutrition-summary { grid-template-columns:repeat(2,1fr); } article { align-items:flex-start; flex-direction:column; } .actions { justify-content:flex-start; } .add-item { flex-wrap:wrap; } .add-item select:nth-child(2) { flex-basis:150px; } } @media(max-width:420px) { .add,.editor-fields { flex-wrap:wrap; } .add input { min-width:160px; } }
</style>
