...
<style>
  ...
  .workspace-header { position:sticky; top:env(safe-area-inset-top, 0px); z-index:30; margin:0 -12px; padding:2px 64px 2px 12px; border-bottom:1px solid var(--border-subtle); background:var(--color-bg); }
