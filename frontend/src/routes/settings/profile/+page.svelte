...
<svelte:head><title>FitTrack – Körperprofil</title></svelte:head>
...
<section class="notice"><strong>Hinweis zu Körperzusammensetzung</strong><p>Körperzusammensetzung ist eine BIA-Schätzung zur Verlaufskontrolle und keine medizinische Messung oder Diagnose. Ohne echte Impedanzdaten zeigt FitTrack nur Gewicht und BMI.</p></section></div>
