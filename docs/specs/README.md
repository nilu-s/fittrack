...
| --- | --- | --- | --- | --- |
| `native-travel-companion.md` | approved for implementation | iOS/Android sessions, private travel monitoring, native location and existing todo highlight | Native lifecycle, auth, migration, worker/push, routes and travel UI | `backend/tests/test_native_travel.py`, migration rehearsal, frontend checks, device acceptance |
